...
const ProfileTabOne = ({ control, getValues, setValue }) => {
  ...
  const handleEdit = () => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        expires_in: localUser.expirationTime,
  ...
  const renderCellName = (row) => {
    return (
      <Flex align="center">
        ...
        <Tooltip
          hasArrow
          label={row.original.local?.address}
          fontSize="14px"
          bgColor="#333333"
        >
    ...
    <Flex direction="column" justifyContent="space-between" h="100%">
      ...
      >
        ...
        >
          ...
          <Stack direction={['column', 'row']} spacing="20px" mb="30px">
            <Avatar
              name={localUser?.name}
              src={files[0]?.preview || userDetail?.image}
              size="2xl"
            />
          ...
          {files.length > 0 && (
            <Stack direction={['column', 'row']} mb="30px">
          ...
          {history.length > 0 && (
            <Fade in={true}>
              <Text fontSize="14px" color="brand.gray1" fontWeight="700">
                {' '}
                History{' '}
              </Text>
              <Box mt="70px">
      ...
      <Box h="15%">
        ...
        <Flex
          ...
          alignItems="center"
        >
          <Button variant="secondary2" mr="20px" onClick={() => handleEdit()}>
            Save
          </Button>
        </Flex>
      </Box>
